...
ROWS: list[tuple[int, str, list[str]]] = [
    ...
    (5, "Heading Architecture", ["headings.structure", "onpage.heading_order", "geo.heading_coverage"]),
    ...
    (7, "Featured Answer Blocks (AEO Core)", ["geo.aeo", "geo.definitive", "geo.no_content",
                                              "geo.answer_self_contained", "geo.definition_present"]),
    (8, "Summary Bullets Near Top", ["geo.summary_bullets", "geo.no_content"]),
    (9, "FAQ Section Quality", ["geo.faq", "geo.qa_headings", "geo.no_content", "geo.question_coverage"]),
