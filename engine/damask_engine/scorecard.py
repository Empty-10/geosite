...
ROWS: list[tuple[int, str, list[str]]] = [
    ...
    (6, "Intro Block Quality", ["geo.frontload", "geo.intro_quality"]),
    (7, "Featured Answer Blocks (AEO Core)", ["geo.aeo", "geo.definitive"]),
    (8, "Summary Bullets Near Top", ["geo.summary_bullets"]),
    (9, "FAQ Section Quality", ["geo.faq", "geo.qa_headings"]),
    (10, "Chunking & Extractable Paragraphs", ["geo.chunking", "geo.depth", "geo.thin_content",
                                               "geo.data_density"]),
    (11, "Lists & Tables for Extractability", ["geo.structure"]),
    ...
    (17, "Performance & Delivery", ["tech.resource_hints", "tech.compression", "perf.score",
                                    ...
                                    "perf.field"]),
    (18, "Authority, Trust & E-E-A-T", ["geo.trust"]),
