// FAQ content, shared between the visible <Faq> accordion and the FAQPage JSON-LD on the
// homepage — one source of truth so the structured data always matches what users see.
export const QA = [
  {
    q: "What is Astova?",
